...
class CounterCubit extends Cubit<CounterState> {
  ...
  late StreamSubscription internetStreamSubsctiption;
  ...
  void monitorInternetConnection() {
    internetStreamSubsctiption = internetCubit.stream.listen((internetState) {
  ...
  @override
  Future<void> close() {
    internetStreamSubsctiption.cancel();
    return super.close();
  }
}
